...
function init() {
	...
	*/
    ...
    map: map,
    icon: 'assets/images/logos/logoBBmini.png'
    });
    ...
    map: map,
    icon: 'assets/images/logos/logoCRmini.png'
    });

    // Center Ridge INFO WINDOW
    var infowindow2 = new google.maps.InfoWindow({
    content: '<strong>Center Ridge</strong><br />38600 Center Ridge Road<br />North Ridgeville, Ohio 44039<br />440-327-1295<br /><br /><a href="#" target="_blank">Read more</a>'
    });
    // End of infowindow code
    ...
    map: map,
    icon: 'assets/images/logos/logoLakewoodmini.png'
    });

    // Lakewood INFO WINDOW
    var infowindow3 = new google.maps.InfoWindow({
    content: '<strong>Lakewood</strong><br />13900 Detroit Avenue<br />Lakewood, OH 44107<br />216-228-7650 <br /><br /><a href="#" target="_blank">Read more</a>'
    });
    // End of infowindow code
    ...
    map: map,
    icon: 'assets/images/logos/logoWPmini.png'
    });

    // Wellington Place INFO WINDOW
    var infowindow4 = new google.maps.InfoWindow({
    content: '<strong>Wellington Place</strong><br />4800 Clague Road<br />North Olmsted, Ohio 44070<br />440-734-9933<br /><br /><a href="#" target="_blank">Read more</a>'
    });
    // End of infowindow code
